...
// const uri = "mongodb://xzz:zzzxxxccc@101.43.17.236:77";  // 容器内通信需要以容器ip连接,而不是网关ip
...
//  ☆  踩坑记录   新版本uri需要 加上 +srv
const uri = "mongodb+srv://xzz:zzzxxxccc@cluster0.bhjpywr.mongodb.net/?retryWrites=true&w=majority";  // 容器内通信需要以容器ip连接,而不是网关ip
